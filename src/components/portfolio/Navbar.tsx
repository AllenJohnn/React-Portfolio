...
const DATA = {
  navbar: [
    ...
    { id: "about", icon: CalendarIcon, label: "About" },
    ...
    { id: "contact", icon: PencilIcon, label: "Contact" },
  ],
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/AllenJohnn",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/allenjohnjoy/",
        icon: Icons.linkedin,
      },
      X: {
        name: "X",
      ...
      Email: {
        name: "Send Email",
        url: "mailto:allenjohnjoy2004@gmail.com",
        icon: Icons.email,
      },
    },
  },
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  ...
                  className={cn(
                    buttonVariants({ variant: "ghost", size: "icon" }),
                    "h-11 w-11 rounded-full hover:bg-accent/80"
                  )}
                >
